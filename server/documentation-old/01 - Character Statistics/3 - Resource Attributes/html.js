...
const secondarySkillHtml = Object.keys(resourceAttributes).map(attribute => (
...
const html = `<p>These resources statistics are derived from the character’s attributes, backgrounds, skills, and traits.</p>${secondarySkillHtml.join("")}`;
